...
urlpatterns = [
    ...
    path('manage-wards/<int:ward_id>/edit/', views.edit_ward, name='edit_ward'),
    ...
    path('api/worker-history/<int:worker_id>/', views.worker_history_api, name='worker_history_api'),
