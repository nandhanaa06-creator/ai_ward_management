...
urlpatterns = [
    ...
    path('<int:complaint_id>/tactical/', views.worker_task_detail, name='tactical_task_view'),
    path('<int:complaint_id>/complete/', views.complete_task, name='complete_task'),
    path('<int:complaint_id>/task-detail/', views.worker_task_detail, name='worker_task_detail'),
    path('<int:complaint_id>/feedback/', views.submit_feedback, name='feedback_form'),
    path('<int:complaint_id>/submit-feedback/', views.submit_feedback, name='submit_feedback'),
